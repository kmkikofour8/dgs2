 ...
 */
set_include_path($_SERVER['DOCUMENT_ROOT'].'vendor/google/apiclient/src');
 ...
 */
const CLIENT_ID = '73577313401-lj9ndq2a8n09vkpfcchrvdgri6q4ako8.apps.googleusercontent.com';

/**
 * Replace this with the client secret you got from the Google APIs console.
 */
const CLIENT_SECRET = 'aALbhqmkdLVPdUiTriDqN8mG';

/**
 * Optionally replace this with your application's name.
 */
const APPLICATION_NAME = "Dog Gear Sell";
